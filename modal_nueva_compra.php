      ...
      <form method="POST" action="guardar_compra.php">
        ...
        <div class="modal-body row g-3">
          ...
          <div class="col-md-6">
            ...
            <input type="text" name="nit_ci_proveedor" class="form-control" required>
          </div>
          ...
          <div class="col-md-6">
            ...
            <select name="tipo_de_compra" class="form-select" required>
              <option value="Con Crédito Fiscal">Con Crédito Fiscal</option>
              <option value="Sin Crédito Fiscal">Sin Crédito Fiscal</option>
              <option value="Gasto No Deducible">Gasto No Deducible</option>
            </select>
          </div>

          <input type="hidden" name="id_cliente" id="id_cliente_hidden" value="<?= isset($_GET['id_cliente']) ? intval($_GET['id_cliente']) : (isset($_SESSION['id_usuario']) ? intval($_SESSION['id_usuario']) : '') ?>">
